                                        ...
                                        <div className="card h-100">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="d-flex justify-content-between mt-2">
                                                    <button className="btn btn-primary" onClick={() => handleEditEvent(event)}>Edit</button>
                            ...
                            <div className="card mb-4">
                                <div className="card-body">
                                    <div className="d-flex align-items-center">
                                        <img src={auth?.user?.avatar} className="rounded-circle me-3" alt={auth?.user?.firstName} style={{ width: '64px', height: '64px' }} />
                                        <div>
